            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Ein österreichisches Betrugsopfer erhielt kürzlich 8,69 Bitcoin zurück – ein Wert von rund 800.000 EUR (Stand Juli 2025). Möglich wurde dies durch die Zusammenarbeit zwischen unserer Kanzlei Korte & Partner, den Strafverfolgungsbehörden und dem gezielten Einsatz von Blockchain-Forensik.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
