...
export default function Stellenangebote() {
  // Set page title
  useEffect(() => {
    document.title = 'Karriere bei Korte & Partner – Stellenangebote';
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background">
      <EditorialHero
        eyebrow="Korte & Partner — Karriere"
        breadcrumb={[
          { label: "Home", href: "/" },
          { label: "Karriere" },
        ]}
        title={<>Karriere bei<br />Korte & Partner.</>}
      ...
      <Section className="py-20 bg-gradient-to-br from-background via-background to-primary/5">
        <div className="container mx-auto px-4">
          <SectionHeader>
            <SectionTitle>Arbeiten bei Korte & Partner</SectionTitle>
            <SectionDescription>
